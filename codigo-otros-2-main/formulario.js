...
let campoEdad = document.getElementById("age");
let campoNacionalidad = document.getElementById("nacionality");
...
formulario.addEventListener("submit", function (event) {
  ...
  let i = campoNacionalidad.selectedIndex
  var nacionalidad = campoNacionalidad.options[i].value
